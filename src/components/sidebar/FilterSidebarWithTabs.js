...
import { Icon, NumberInputField, TextInputField } from "../Component";
...
const FilterSidebarWithTabs = ({ toggle, children }) => {
  const {
    register,
    selectedScheme,
    SetSelectedSchene,
  ...
  const { schemes } = useSchemes(props?.isSchemeFilterReq);
  ...
  return (
    <>
      ...
      <Row className="g-gs" style={{ flexGrow: 1 }}>
        <Col md={4}>
          <ul className="nav link-list-menu border border-light round ">
            {(is_date_filter_req || is_group_by_req || is_year_filter_req) && (
              <li>
                <a
                  href="#tab"
        ...
        <Col md={8}>
          <TabContent activeTab={verticalIconTab}>
            ...
            <TabPane style={{ overflow: "visible" }} tabId="2">
              {props?.isBranchFilterReq && (
              ...
              {props?.isVoucherIssueStatusFilter && (
                <Col className="mt-2" lg="12">
                  <div className="form-group">
                    <label
                      className="form-label"
                      htmlFor="filterVoucherIssueType"
                    >
                      Voucher Type
                    </label>
                    <SelectDropdown
                ...
                <Col className="mt-2" lg="12">
                  <div className="form-group">
                    ...
                    <SelectDropdown
                      ...
                      setValue={setValue}
                      message={
                        errors?.filterReportType && "Report Type is Required"
                      }
                    />
                  </div>
                </Col>
...
export default FilterSidebarWithTabs;
