        ...
        <div className="body">
            ...
            {invoiceData?.jewel_not_deliver_details?.length > 0 && (
                <div className="salesDetails">
                    ...
                    <div className="" style={{textAlign:"center"}}>
                        <span>Office Copy</span><br></br>
                    </div><br></br>
                    <div className="header">
                        <div className="info">
                            <div  style={{ textTransform: "uppercase" }}>
                                <span>{invoiceData.customer_name}</span> <br></br>
                                <span>{invoiceData.customer_mobile}</span>
                            </div>
                    ...
                    <table className="sales_details" style={{ width: "100%" }}>
                        ...
                        <tbody>
                            ...
                            <tr style={{ fontWeight: "bold" }}>
                                <td className="alignleft" colSpan={2} >CREDIT AMOUNT</td>

                                <td className="alignright" colSpan={2} >{formatCurrencyInINR(invoiceData.due_amount)}</td>
...
export default JewelNotDeliverTemplate;
