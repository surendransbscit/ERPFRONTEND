...
const MetalIssue = () => {
    ...
    const { estimationDashList } = useSelector((state) => state.purchaseDashboardReducer);
    ...
    return (
        <Card className="shadow-sm">
            <div className="card-inner border-bottom p-2 d-flex justify-content-between align-items-center bg-success text-white rounded-top">
