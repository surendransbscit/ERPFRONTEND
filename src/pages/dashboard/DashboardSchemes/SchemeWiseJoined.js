...
const SchemeWiseJoined = () => {
  ...
  const joinedData = schemeWiseJoinedList?.map((obj, idx) => {
    const container = {};
  ...
  useEffect(() => {
    dispatch(getSchemeWiseJoined({ days: days }));
  }, [dispatch, days]);
          ...
          <div className="card-inner flex-grow-1">
            <div className="card-title-group mb-4">
              <div className="card-title">
                <h6 className="title"> Scheme Wise Joined</h6>
              </div>
...
export default SchemeWiseJoined;
