...
const BranchWiseSchemeJoined = () => {
  ...
  const joinedData = branchWiseSchemeJoinedList?.map((obj, idx) => {
    const container = {};
  ...
  useEffect(() => {
    dispatch(getBranchWiseSchemeJoined({ days: days }));
  }, [dispatch, days]);
          ...
          <div className="card-inner flex-grow-1">
            <div className="card-title-group mb-4">
              <div className="card-title">
                <h6 className="title">Branch Wise Scheme Joined</h6>
              </div>
            ...
            {joinedData?.length > 0 ? (
              <div className="data-group">
                <div className="nk-ecwg4-ck">
                  <TrafficSourcesChart state={joinedData} />
                </div>
...
export default BranchWiseSchemeJoined;
