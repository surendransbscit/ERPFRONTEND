          ...
          <div className="salesDetails">
            <table className="sales_details" style={{ width: "100%" }}>
              ...
              <tbody>
                ...
                <tr>
                  <td colSpan="5">
                  Issued with thanks To Mr./Ms. { itemDetails.supplier_name } with the sum of 
                  { itemDetails.amount } as payment 
                  </td>
                  <td  className="alignright">
...
export default SupplierPaymentPrintA4;
