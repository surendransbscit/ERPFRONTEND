...
import { getBankStatementReport } from "../../redux/thunks/reports";
...
import { useBanks } from "../../components/filters/filterHooks";
...
const BankStatementReport = () => {
  ...
  const { bankStatementList, isLoading: loadingData } = useSelector((state) => state.reportReducer);
  ...
  return (
    <React.Fragment>
      <Head title={pagePermission?.title ? pagePermission?.title : "Bank Statement Reports"}></Head>
      {pagePermission?.view && (
        <Content>
          <Block size="lg">
                    ...
                    <table className="table-wrapper react_table">
                      ...
                      <tbody>
                        ...
                        { bankStatementList.length > 0 &&
                          Object.entries(bankStatementList).map(([date, items]) => {
                            return (
                              <React.Fragment key={date}>
                                <tr style={{ fontWeight: "bold" }}>
                                  ...
                                  <td style={{ textAlign: "right" }} > <CurrencyDisplay value={items.opening} /></td>
