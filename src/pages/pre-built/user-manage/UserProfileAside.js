...
import { getEmployeeDetails } from "../../../redux/thunks/employee";
    ...
    <div className="card-inner-group">
      <div className="card-inner">
        <div className="user-card">
          {/* <UserAvatar
            text={findUpper(profileDetailsInfo?.firstname)}
            theme="primary"
          /> */}
          <div className="user-info">
            <span className="lead-text">{profileDetailsInfo?.name}</span>
            <span className="sub-text">{profileDetailsInfo?.email}</span>
          </div>
